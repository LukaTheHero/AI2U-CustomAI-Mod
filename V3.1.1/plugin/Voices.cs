...
namespace AI2UCustomAI
{
    internal static class Voices
    {
        ...
        // Deliberately not every Character enum member: MagicCircle, Ghost and
        // System are not speaking roles with their own identity, and listing them
        // would pad the panel with rows that never do anything.
        //
