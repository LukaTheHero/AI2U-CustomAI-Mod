...
namespace AI2UCustomAI
{
    internal static class Lore
    {
        ...
        static void Journals(StringBuilder sb)
        {
            ...
            if (records.Count > 0)
            {
                // "Ship", not "station": the vessel is the Magpie Bridge, a
                // spaceship on a mission - it flies, it has an engine to
                // repair and escape pods to leave in. One shipped crew-file
                // heading does say "Magpie Bridge Space Station", so the
                // game's own text is inconsistent; "ship" is what the level's
                // mechanics make true, and a mislabel here reads as her not
                // knowing what she is standing in.
                sb.Append("\nYour ship's records - your crew, their notes, their files and ");
                sb.Append("their mail. You are this ship's system: these are your records ");
